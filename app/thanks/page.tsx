...
export default function ThanksPage() {
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-6 py-12 md:py-16">
      <section className="space-y-5 rounded-2xl border border-white/10 bg-white/5 p-5 text-center shadow-2xl shadow-cyan-950/20 backdrop-blur md:rounded-[2rem] md:p-8">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <Link href="/historie" className="rounded-2xl border border-white/10 bg-slate-900/70 p-5 transition hover:bg-white/5 md:rounded-[2rem] md:p-6">
        ...
        <Link href="/" className="rounded-2xl border border-white/10 bg-slate-900/70 p-5 transition hover:bg-white/5 md:rounded-[2rem] md:p-6">
